...
exports.activePiecesProp = activePiecesProp;
const vscode = __importStar(require("vscode"));
const ap_templates_1 = require("../activepieces/ap-templates");
const ap_enum_1 = require("../activepieces/ap-enum");
async function activePiecesProp() {
    ...
    switch (propType) {
        ...
        case ap_enum_1.ActivepiecesPropertyType.JSON:
            ...
            break;
        case ap_enum_1.ActivepiecesPropertyType.DICTIONARY:
            output = (0, ap_templates_1.generateDictionary)(isRequired);
            break;
...
//# sourceMappingURL=ap-props.js.map